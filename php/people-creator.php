...
function watu_create_people_storage() {
	...
	if( metadata_exists( 'post', PEOPLE_STORAGE, '_watu_people_tmdb_id_storage' ) == false && ! empty( post_exists( 'Watu People Storage' ) ) ) add_post_meta( PEOPLE_STORAGE, '_watu_people_tmdb_id_storage', array( 50 ) );
