...
function watu_create_movie_storage() {
	...
	if( metadata_exists( 'post', MOVIE_STORAGE, '_watu_movie_tmdb_id_storage' ) == false && ! empty( post_exists( 'Watu Movie Storage' ) ) ) add_post_meta( MOVIE_STORAGE, '_watu_movie_tmdb_id_storage', array( 50 ) );
